...
/**
 * A type-to-instance map backed by an {@code ImmutableMap}. See also {@code
...
public final class ImmutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B>
   ...
   * }</pre>
   *
   * <p>After invoking {@code #build()} it is still possible to add more entries and build again.
  ...
  public static final class Builder<B> {
     ...
     * and will cause {@code #build} to fail.
     */
